...
import html
import requests
import Yumeko.modules.sql.chatbot_sql as sql
...
from Yumeko.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from Yumeko import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "CHIZURU AI Chatbot disable by {}.".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "CHIZURU AI Chatbot enable by {}.".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Chizuru Enabled Chats</b>\n"
    for chat in chats:
        try:
