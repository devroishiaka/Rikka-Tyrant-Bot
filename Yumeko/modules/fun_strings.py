...
SLAP_TEMPLATES = ("{user 2} was burned by the flame of darkness.",
    "https://telegra.ph/file/fb3fe539f210eea256856.mp4 {user1} hits {user2}",
    "{user2} starved without pats.",
    "{user2} was knocked into the void by {user1}.",
    "https://telegra.ph/file/5cdc5f0b1754a5200334e.mp4 {user2} fainted.",
    ...
    "https://telegra.ph/file/f80503c80dcd43d7f5731.mp4 {user2} was sliced and diced by {user1}.",
    "{user2} played hot-potato with a grenade.",
    "https://telegra.ph/file/221548af5e9b528ef5815.mp4 {user2} was knifed by {user1}.",
    "https://telegra.ph/file/277694694a865db90a4e7.mp4 {user1} hits {user2}",
    ...
    "https://telegra.ph/file/3bfb8406a0e6302e67e9b.mp4 {user1} put {user2} in the friendzone.",
    "{user1} slaps {user2} with a DMCA takedown request!",
    "{user2} got a house call from Doctor {user1}.",
    "https://telegra.ph/file/eced6e3f4feb52d6ede67.mp4 {user1} beheaded {user2}.",
    ...
    "https://telegra.ph/file/24739644f19d649599c3d.mp4 {user1} {hits} {user2} with a bat!.",
    "https://telegra.ph/file/e3222da1935db385921d1.mp4 {user1} {hits} {user2} with a Taijutsu Kick!.",
    "{user1} {hits} {user2} with X-Gloves!.",
    "https://telegra.ph/file/e1b2b1d59525f7121ccd4.mp4 {user1} {hits} {user2} with a Jet Punch!.",
    ...
    "https://telegra.ph/file/83e580fec112a6c074eb8.mp4 {user1} pokes {user2}!",
    ...
    "( ・∀・)ｒ鹵~<≪巛;ﾟДﾟ)ﾉ\n*Bug sprays {user2}*.",
    "( ﾟДﾟ)ﾉ占~<巛巛巛.\n-{user2} You pest!",
    "https://telegra.ph/file/d16f74d7d12c66e46971a.mp4 {user1} bullies {user2}",
    ...
    "https://telegra.ph/file/6c32bbf1c58035ec7d6a7.mp4 {user1} bullied {user2}.",
    ...
    "https://telegra.ph/file/277625f3a5d253d0b4ba7.mp4 {user1} kicks {user2}",
    ...
    "https://telegra.ph/file/e2664b090cfbe6c72ab14.mp4 {user1} performed an Avada Kedavra spell on {user2}.",
    ...
    "https://telegra.ph/file/343af31d59fa29cb19268.mp4{user1} hits {user2}",  # Pixels pet cat - @NeoTheKitty
...
PAT_TEMPLATES = (
    ...
    "https://telegra.ph/file/230b080082233f87eecac.mp4 Pat, pat, pat, pat",
